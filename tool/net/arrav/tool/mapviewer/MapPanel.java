...
public class MapPanel extends JPanel {
	...
	/**
	 * The tool.mapviewer panels context (parent)
	 */
	...
	/**
	 * X coordinate of the center of the tool.mapviewer portion we are viewing
	 */
	public int centerX = 3080;
	
	/**
	 * Y coordinate of the center of the tool.mapviewer portion we are viewing
	 */
	...
	/**
	 * Creates a MapPanel, loads the tool.mapviewer and registers listeners for the
	 * component
	 */
	...
	/**
	 * Clears the panel, draws the section of the tool.mapviewer being viewed and then
	 * draws the selections over the tool.mapviewer
	 */
	@Override
	...
	public void setView(Rectangle rect) {
		...
		// Center the tool.mapviewer on the center of the selected rectangle
