...
//import com.rageps.net.packet.out.SendAddFriend;
//import com.rageps.net.packet.out.SendPrivateMessage;
...
//			if(name == 0)
//				continue;
//			player.out(new SendAddFriend(name, World.get().getPlayer(name).isPresent()));
//		}
//	}
//
//	/**
