 ...
 */
public class SecondItemPacketDecoder implements PacketDecoder<SecondItemActionPacket> {

    @Override
    public SecondItemActionPacket decode(GamePacket packet) {
        ...
        return new SecondItemActionPacket(container, slot, id);
    }
}
