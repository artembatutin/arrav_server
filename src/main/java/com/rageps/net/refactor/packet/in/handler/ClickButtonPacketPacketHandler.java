...
import static com.rageps.action.ActionContainers.BUTTONS;

/**
 * @author Tamatea <tamateea@gmail.com>
 */
public class ClickButtonPacketPacketHandler implements PacketHandler<ClickButtonPacketPacket> {



    private static int hexToInt(byte[] data) {// todo get rid of this shit
        int value = 0;
        int n = 1000;
        for(byte aData : data) {
    ...
    @Override
    public void handle(Player player, ClickButtonPacketPacket packet) {

        int button = packet.getId();
