...
import com.rageps.content.skill.agility.impl.barb.BarbarianOutpostAgility;
import com.rageps.content.skill.agility.impl.gnome.GnomeStrongholdAgility;
...
public final class AgilityCourseBonus {
	 ...
	 */
	private final EnumSet<GnomeStrongholdAgility.GnomeAgilityData> gnome_course = EnumSet.noneOf(GnomeStrongholdAgility.GnomeAgilityData.class);
	 ...
	 */
	public void addGnomeObstacle(GnomeStrongholdAgility.GnomeAgilityData data) {
