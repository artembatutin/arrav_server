...
import com.rageps.world.entity.actor.combat.attack.listener.other.prayer.regular.attack.ImprovedReflexesListener;
import com.rageps.world.entity.actor.combat.attack.listener.other.prayer.regular.attack.IncredibleReflexesListener;
import com.rageps.world.entity.actor.combat.attack.listener.other.prayer.regular.defence.RockSkinListener;
import com.rageps.world.entity.actor.combat.attack.listener.other.prayer.regular.defence.SteelSkinListener;
import com.rageps.world.entity.actor.combat.attack.listener.other.prayer.regular.defence.ThickSkinListener;
import com.rageps.world.entity.actor.combat.attack.listener.other.prayer.regular.magic.MysticLoreListener;
import com.rageps.world.entity.actor.combat.attack.listener.other.prayer.regular.magic.MysticMightListener;
import com.rageps.world.entity.actor.combat.attack.listener.other.prayer.regular.magic.MysticWillListener;
import com.rageps.world.entity.actor.combat.attack.listener.other.prayer.regular.ranged.EagleEyeListener;
import com.rageps.world.entity.actor.combat.attack.listener.other.prayer.regular.ranged.HawkEyeListener;
import com.rageps.world.entity.actor.combat.attack.listener.other.prayer.regular.ranged.SharpListener;
import com.rageps.world.entity.actor.combat.attack.listener.other.prayer.regular.strength.BurstOfStrengthListener;
