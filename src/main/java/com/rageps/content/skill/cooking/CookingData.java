...
public enum CookingData {
	...
	REDBERRY_PIE(2321, 10, 2325, 21, Cooking.BURNT_PIE.getId(), 70),
	MEAT_PIE(2319, 20, 2327, 31, Cooking.BURNT_PIE.getId(), 110),
	MUD_PIE(7168, 29, 7170, 40, Cooking.BURNT_PIE.getId(), 120),
	APPLE_PIE(2317, 30, 2323, 41, Cooking.BURNT_PIE.getId(), 130),
	GARDEN_PIE(7176, 34, 7178, 45, Cooking.BURNT_PIE.getId(), 135),
	FISH_PIE(7186, 47, 7188, 58, Cooking.BURNT_PIE.getId(), 140),
	ADMIRAL_PIE(7196, 70, 7198, 81, Cooking.BURNT_PIE.getId(), 210),
	WILD_PIE(7206, 85, 7208, 96, Cooking.BURNT_PIE.getId(), 240),
	SUMMER_PIE(7216, 95, 7218, 99, Cooking.BURNT_PIE.getId(), 260),
