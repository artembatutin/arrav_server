...
public final class Pickpocketing extends Thieving {
	...
	private enum PickpocketData {
		...
		GUARD(new int[]{9, 10, 5920}, new Item[]{new Item(995, 700), new Item(2351, 1), new Item(199, 1), new Item(313, 4), new Item(453, 1), new Item(562, 12), new Item(712, 1), new Item(950, 1), new Item(1623, 1)}, 40, 46.5, 3, 20),
