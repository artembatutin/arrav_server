...
public enum WeaponInterface {
	 ...
	 * @param id           the identification of the interface that will be displayed.
	 ...
	 * @param specialBar   the identification of the special bar for this interface.
	 * @param specialMeter the identification of the special meter for this interface.
	 */
