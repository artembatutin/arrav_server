package net.edge.world.node.actor.npc.strategy.impl.glacor;
...
import net.edge.world.node.actor.npc.impl.glacor.GlacorExplodeTask;
import net.edge.world.node.actor.npc.impl.glacor.GlacyteData;
import net.edge.world.node.actor.npc.strategy.DynamicCombatStrategy;
...
public final class GlacorCombatStrategy extends DynamicCombatStrategy<Glacor> {
	...
	private CombatHit icycleSpecialAttack(Actor victim) {
