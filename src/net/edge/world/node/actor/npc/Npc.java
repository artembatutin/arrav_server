...
import net.edge.world.node.actor.npc.impl.KalphiteQueen;
import net.edge.world.node.actor.npc.impl.corp.CorporealBeast;
import net.edge.world.node.actor.npc.impl.glacor.Glacor;
import net.edge.world.node.actor.npc.impl.gwd.CommanderZilyana;
import net.edge.world.node.actor.npc.impl.gwd.GeneralGraardor;
import net.edge.world.node.actor.npc.impl.gwd.KreeArra;
import net.edge.world.node.actor.npc.strategy.impl.TormentedDemonCombatStrategy;
import net.edge.world.node.actor.npc.strategy.impl.WildyWyrmCombatStrategy;
