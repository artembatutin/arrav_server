package net.edge.world.node.actor.npc.drop;
 ...
 */
public class SuggestedDrop extends NpcDrop {
	 ...
	 */
	public NpcDrop toDrop() {
		return new NpcDrop(getId(), getMinimum(), getMaximum(), getChance());
	}
