...
public final class NpcDefinition {
	 ...
	 */
	public static final NpcDefinition[] DEFINITIONS = new NpcDefinition[16733];
	...
	public static Optional<NpcDefinition> fromString(String name) {
		return Arrays.stream(DEFINITIONS).filter($it -> $it.getName().equalsIgnoreCase(name)).findAny();
	}
	
	public static Optional<NpcDefinition> fromSlayerKey(String key) {
	...
	public static void dump() {
		...
		for(NpcDefinition d : NpcDefinition.DEFINITIONS) {
