package net.edge.world.node.actor.player;
...
public final class PlayerAppearance {
	...
	public PlayerAppearance() {
		this.gender = PlayerAppearance.GENDER_MALE;
		this.chest = 18;
		this.arms = 26;
		this.legs = 36;
		this.head = 0;
	...
	public boolean isMale() {
		return gender == PlayerAppearance.GENDER_MALE;
	}
	...
	public boolean isFemale() {
		return gender == PlayerAppearance.GENDER_FEMALE;
	}
	...
	/**
	 * Sets the value for {@link PlayerAppearance#gender}.
	 * @param gender the new value to set.
	 */
	...
	/**
	 * Sets the value for {@link PlayerAppearance#chest}.
	 * @param chest the new value to set.
	 */
	...
	/**
	 * Sets the value for {@link PlayerAppearance#arms}.
	 * @param arms the new value to set.
	 */
	...
	/**
	 * Sets the value for {@link PlayerAppearance#legs}.
	 * @param legs the new value to set.
	 */
	...
	/**
	 * Sets the value for {@link PlayerAppearance#head}.
	...
	/**
	 * Sets the value for {@link PlayerAppearance#hands}.
	 * @param hands the new value to set.
	 */
	...
	/**
	 * Sets the value for {@link PlayerAppearance#feet}.
	 * @param feet the new value to set.
	 */
	...
	/**
	 * Sets the value for {@link PlayerAppearance#beard}.
	 * @param beard the new value to set.
	 */
	...
	/**
	 * Sets the value for {@link PlayerAppearance#hairColor}.
	 * @param hairColor the new value to set.
	 */
	...
	/**
	 * Sets the value for {@link PlayerAppearance#torsoColor}.
	 * @param torsoColor the new value to set.
	 */
	...
	/**
	 * Sets the value for {@link PlayerAppearance#legColor}.
	 * @param legColor the new value to set.
	 */
	...
	/**
	 * Sets the value for {@link PlayerAppearance#feetColor}.
	 * @param feetColor the new value to set.
	 */
	...
	/**
	 * Sets the value for {@link PlayerAppearance#skinColor}.
	 * @param skinColor the new value to set.
	 */
