package net.edge.world.node.actor.mob.impl.glacor;

import net.edge.locale.Position;
import net.edge.world.Hit;
import net.edge.world.World;
import net.edge.world.node.actor.mob.Mob;
import net.edge.world.node.actor.mob.strategy.impl.glacor.GlacorCombatStrategy;
import net.edge.world.node.actor.mob.strategy.impl.glacor.GlacyteCombatStrategy;
