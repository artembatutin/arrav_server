package net.edge.world.node.actor.move.path.distance;

import net.edge.locale.Position;

/**
 * An interface to calculate the distance between two nodes in a {@link Position}
...
public interface Distance {
	...
	/**
	 * The Manhattan Distance is the distance between two points measured along axes at right angles. The name alludes to
	 * the grid layout of the streets of Manhattan, which causes the shortest path a car could take between two points in
	 * the city. Perfect for 4 dimensional movements.
	 * @author Artem Batutin <artembatutin@gmail.com>
	 */
