...
public final class ForcedMovementManager {
	 ...
	 */
	private static boolean prerequisites(EntityNode character) {
		if(character.isNpc()) {
			return true;
		}
	 ...
	 */
	public static void submit(EntityNode character, ForcedMovement movement) {
	 ...
	 */
	public static void submit(EntityNode character, ForcedMovement movement, boolean skipPrerequisites) {
