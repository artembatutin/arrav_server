 ...
 */
public final class TormentedDemonStrategy extends DynamicStrategy<Mob> {
	...
	/**
	 * Constructs a new {@link TormentedDemonStrategy}.
	 * @param mob the mob to register this combat strategy for.
	 */
	public TormentedDemonStrategy(Mob mob) {
		super(mob);
	}
	...
	private static final class ShieldRestorationTask extends Task {
		 ...
		 */
		public ShieldRestorationTask(TormentedDemonStrategy strategy) {
			super(100);
	...
	private static final class SwitchAttackTask extends Task {
		 ...
		 * @param strategy {@link #strategy}.
		 */
		public SwitchAttackTask(TormentedDemonStrategy strategy) {
			super(30);
			this.strategy = strategy;
		}
	...
	private static final class SwitchPrayerTask extends Task {
		 ...
		 * @param strategy {@link #strategy}.
		 */
		public SwitchPrayerTask(TormentedDemonStrategy strategy) {
			super(20);
			this.strategy = strategy;
		}
