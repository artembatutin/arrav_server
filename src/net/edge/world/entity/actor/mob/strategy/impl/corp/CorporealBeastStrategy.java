 ...
 */
public final class CorporealBeastStrategy extends DynamicStrategy<CorporealBeast> {

	/**
	 * Constructs a new {@link CorporealBeastStrategy}.
	 * @param npc the npc which is an instance of {@link CorporealBeast}.
	 */
	public CorporealBeastStrategy(CorporealBeast npc) {
		super(npc);
	}
