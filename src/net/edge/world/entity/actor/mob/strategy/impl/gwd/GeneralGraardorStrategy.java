 ...
 */
public final class GeneralGraardorStrategy extends DynamicStrategy<GeneralGraardor> {

	/**
	 * Creates a new {@link GeneralGraardorStrategy}.
	 * @param npc the npc this strategy is for.
	 */
	public GeneralGraardorStrategy(GeneralGraardor npc) {
		super(npc);
	}
