package net.edge.world.entity.actor.mob.strategy.impl.gwd;
 ...
 */
public final class CommanderZilyanaStrategy extends DynamicStrategy<CommanderZilyana> {
	
	/**
	 * Constructs a new {@link CommanderZilyanaStrategy}.
	 * @param npc the npc this strategy is for.
	 */
	public CommanderZilyanaStrategy(CommanderZilyana npc) {
		super(npc);
	}
