package net.edge.world.entity.actor.combat.content.lunars;

import com.google.common.collect.ImmutableSet;
import net.edge.content.dialogue.impl.OptionDialogue;
import net.edge.world.entity.actor.Actor;
import net.edge.world.entity.actor.combat.content.lunars.impl.LunarButtonSpell;
import net.edge.world.entity.actor.combat.content.lunars.impl.LunarCombatSpell;
import net.edge.world.entity.actor.combat.content.lunars.impl.LunarItemSpell;
import net.edge.world.entity.actor.combat.content.lunars.impl.spells.*;
