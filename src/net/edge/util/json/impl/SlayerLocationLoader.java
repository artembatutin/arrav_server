...
public final class SlayerLocationLoader extends JsonLoader {
	...
	public void load(JsonObject reader, Gson builder) {
		...
		Position[] positions = reader.get("position").isJsonArray() ? Objects.requireNonNull(builder.fromJson(reader.get("position").getAsJsonArray(), Position[].class)) : new Position[]{Objects.requireNonNull(builder.fromJson(reader.get("position")
