package net.edge.content.newcombat.attack;//package combat.attack;
...
import net.edge.content.newcombat.hit.HitIcon;
    ...
    private static double roll(Actor actor, double level, FightType fightType, boolean offensive) {
        if (offensive) {
            ...
            switch (fightType.getBonus()) {
                case net.edge.content.combat.CombatConstants.ATTACK_RANGED:
                    bonus = actor.toMob().getDefinition().getCombat().getAttackRanged();
                    break;
                case net.edge.content.combat.CombatConstants.ATTACK_MAGIC:
        ...
        int bonus = 0;
        switch (fightType.getBonus()) {
            case net.edge.content.combat.CombatConstants.DEFENCE_RANGED:
                bonus = actor.toMob().getDefinition().getCombat().getDefenceRanged();
                break;

            case net.edge.content.combat.CombatConstants.DEFENCE_MAGIC:
                bonus = actor.toMob().getDefinition().getCombat().getDefenceMagic();
                break;

            case net.edge.content.combat.CombatConstants.DEFENCE_STAB:
                bonus = actor.toMob().getDefinition().getCombat().getDefenceStab();
                break;

            case net.edge.content.combat.CombatConstants.DEFENCE_CRUSH:
                bonus = actor.toMob().getDefinition().getCombat().getDefenceCrush();
                break;

            case net.edge.content.combat.CombatConstants.DEFENCE_SLASH:
