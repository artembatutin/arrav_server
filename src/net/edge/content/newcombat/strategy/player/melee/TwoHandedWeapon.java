...
public class TwoHandedWeapon extends MeleeStrategy<Player> {
    private static final Animation CRUSH = new Animation(406, Animation.AnimationPriority.HIGH);
    private static final Animation DEFAULT = new Animation(407, Animation.AnimationPriority.HIGH);
