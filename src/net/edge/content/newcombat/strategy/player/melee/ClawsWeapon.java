...
public class ClawsWeapon extends MeleeStrategy<Player> {
    private static final Animation STAB = new Animation(422, Animation.AnimationPriority.HIGH);
    private static final Animation DEFAULT = new Animation(393, Animation.AnimationPriority.HIGH);
