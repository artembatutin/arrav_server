...
public class BattleaxeWeapon extends MeleeStrategy<Player> {
    private static final Animation CRUSH = new Animation(401, Animation.AnimationPriority.HIGH);
    private static final Animation DEFAULT = new Animation(395, Animation.AnimationPriority.HIGH);
