...
public class SwordOrDaggerWeapon extends MeleeStrategy<Player> {
    private static final Animation SLASH = new Animation(395, Animation.AnimationPriority.HIGH);
    private static final Animation DEFAULT = new Animation(412, Animation.AnimationPriority.HIGH);
    ...
    private static Animation getAttackAnimation(Player player) {
        ...
        if (stance == AttackStance.AGGRESSIVE && style == AttackStyle.SLASH) return SLASH;
        return DEFAULT;
    }
