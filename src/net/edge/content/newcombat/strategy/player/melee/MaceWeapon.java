...
public class MaceWeapon extends MeleeStrategy<Player> {
    private static final Animation STAB = new Animation(400, Animation.AnimationPriority.HIGH);
    private static final Animation DEFAULT = new Animation(401, Animation.AnimationPriority.HIGH);
