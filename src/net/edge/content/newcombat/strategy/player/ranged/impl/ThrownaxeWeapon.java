...
public final class ThrownaxeWeapon extends ThrownWeapon {

    public ThrownaxeWeapon(RangedWeaponDefinition definition, CombatProjectileDefinition projectileDefinition) {
        super(definition, projectileDefinition);
    }

    @Override
    public int getAttackDelay(AttackStance stance) {
        return stance.equals(AttackStance.RAPID) ? 4 : 5;
    }
    ...
    protected String getLastThrownMessage() {
        return "You threw your last thrownaxe!";
    }
