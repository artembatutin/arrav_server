...
public enum Achievement {
	...
	FISHER_MAN("Catch %s items in the water", 100, 200, 300, 1000),
	FARMER("Harvest %s items from farming", 100, 200, 300, 1000),
	ARCHER_SUPPORTER("Fletch %s arrows", 50, 100, 200, 1000),
