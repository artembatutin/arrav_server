...
public class CombatHit {
    ...
    /**
     * Tick delay which carries on inbetween hits hence If delay = 2, The first
     * hit will be instant, second hit will have a delay of 2, third hit will
     * have a delay of 4 and so on.. First hit is instant due to the
     * calculateHit method
     */
     ...
     * @param checkAccuracy determines if accuracy should be calculated for
     *                      hits.
     ...
     *
     * @param counter the amount of damage this attack inflicted, always {@code
     *                0} if the attack was inaccurate.
     */
