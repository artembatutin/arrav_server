...
public final class CombatUtil {
	...
	public static Hit calculateRandomHit(Actor character, Actor victim, CombatType type, int delay, boolean checkAccuracy) {
		...
		Hit.HitIcon icon = character.getCombat().getCombatType() == CombatType.MAGIC ? Hit.HitIcon.MAGIC : (character.getCombat().getCombatType() == CombatType.RANGED ? Hit.HitIcon.RANGED : (character.getCombat().getCombatType() == CombatType.MELEE ? Hit.HitIcon.MELEE : Hit.HitIcon.NONE));
