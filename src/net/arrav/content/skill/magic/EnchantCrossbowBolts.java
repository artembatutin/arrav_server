...
import static net.arrav.content.achievements.Achievement.ENCHANTER;
...
public final class EnchantCrossbowBolts extends ProducingSkillAction {
	...
	public static boolean openInterface(Player player, int buttonId) {
		...
		player.text(49013, (inventory.contains(new Item(556, 20)) ? "@gre@" : "@red@") + "20x");
		player.text(49017, (magic.reqLevel(7) ? "@gre@" : "@red@") + "Magic 7");
		player.text(49020, (inventory.contains(new Item(564, 10)) ? "@gre@" : "@red@") + "10x");
		player.text(49021, (inventory.contains(new Item(558, 10)) ? "@gre@" : "@red@") + "10x");
		player.text(49088, (inventory.contains(new Item(555, 10)) ? "@gre@" : "@red@") + "10x");
		player.text(49025, (magic.reqLevel(14) ? "@gre@" : "@red@") + "Magic 14");
		player.text(49028, (inventory.contains(new Item(564, 10)) ? "@gre@" : "@red@") + "10x");
		player.text(49029, (inventory.contains(new Item(557, 20)) ? "@gre@" : "@red@") + "20x");
		player.text(49033, (magic.reqLevel(24) ? "@gre@" : "@red@") + "Magic 24");
		player.text(49036, (inventory.contains(new Item(564, 10)) ? "@gre@" : "@red@") + "10x");
		player.text(49037, (inventory.contains(new Item(555, 20)) ? "@gre@" : "@red@") + "20x");
		player.text(49041, (magic.reqLevel(27) ? "@gre@" : "@red@") + "Magic 27");
		player.text(49044, (inventory.contains(new Item(564, 10)) ? "@gre@" : "@red@") + "10x");
		player.text(49089, (inventory.contains(new Item(556, 30)) ? "@gre@" : "@red@") + "30x");
		player.text(49045, (inventory.contains(new Item(561, 10)) ? "@gre@" : "@red@") + "10x");
		player.text(49049, (magic.reqLevel(29) ? "@gre@" : "@red@") + "Magic 29");
		player.text(49052, (inventory.contains(new Item(564, 10)) ? "@gre@" : "@red@") + "10x");
		player.text(49053, (inventory.contains(new Item(554, 20)) ? "@gre@" : "@red@") + "20x");
		player.text(49057, (magic.reqLevel(49) ? "@gre@" : "@red@") + "Magic 49");
		player.text(49090, (inventory.contains(new Item(564, 10)) ? "@gre@" : "@red@") + "10x");
		player.text(49060, (inventory.contains(new Item(554, 50)) ? "@gre@" : "@red@") + "50x");
		player.text(49061, (inventory.contains(new Item(565, 10)) ? "@gre@" : "@red@") + "10x");
		player.text(49065, (magic.reqLevel(57) ? "@gre@" : "@red@") + "Magic 57");
		player.text(49068, (inventory.contains(new Item(557, 100)) ? "@gre@" : "@red@") + "100x");
		player.text(49069, (inventory.contains(new Item(563, 20)) ? "@gre@" : "@red@") + "20x");
		player.text(49073, (magic.reqLevel(68) ? "@gre@" : "@red@") + "Magic 68");
		player.text(49076, (inventory.contains(new Item(563, 150)) ? "@gre@" : "@red@") + "150x");
		player.text(49077, (inventory.contains(new Item(566, 10)) ? "@gre@" : "@red@") + "10x");
		player.text(49081, (magic.reqLevel(87) ? "@gre@" : "@red@") + "Magic 87");
		player.text(49084, (inventory.contains(new Item(554, 200)) ? "@gre@" : "@red@") + "200x");
