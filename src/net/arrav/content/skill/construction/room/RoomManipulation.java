...
import net.arrav.content.skill.construction.Palette.PaletteTile;
...
import net.arrav.net.packet.out.SendRemoveObjects;
import net.arrav.world.entity.actor.player.Player;
import net.arrav.world.entity.item.Item;

import static net.arrav.content.skill.construction.Construction.*;
import static net.arrav.content.skill.construction.furniture.Furniture.OAK_LADDER;
import static net.arrav.content.skill.construction.furniture.Furniture.OAK_STAIRCASE;
