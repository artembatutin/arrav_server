...
public enum FlowerSeed implements SeedType {
	...
	FlowerSeed(int levelRequirement, Item seed, int[] growthTime, Item[] rewards, Item[] protectionFee, int[] experience, int[] values) {
