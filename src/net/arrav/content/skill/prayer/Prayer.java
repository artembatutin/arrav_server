...
import net.arrav.world.entity.actor.combat.attack.listener.other.prayer.regular.attack.ImprovedReflexesListener;
import net.arrav.world.entity.actor.combat.attack.listener.other.prayer.regular.attack.IncredibleReflexesListener;
import net.arrav.world.entity.actor.combat.attack.listener.other.prayer.regular.defence.RockSkinListener;
import net.arrav.world.entity.actor.combat.attack.listener.other.prayer.regular.defence.SteelSkinListener;
import net.arrav.world.entity.actor.combat.attack.listener.other.prayer.regular.defence.ThickSkinListener;
import net.arrav.world.entity.actor.combat.attack.listener.other.prayer.regular.magic.MysticLoreListener;
import net.arrav.world.entity.actor.combat.attack.listener.other.prayer.regular.magic.MysticMightListener;
import net.arrav.world.entity.actor.combat.attack.listener.other.prayer.regular.magic.MysticWillListener;
import net.arrav.world.entity.actor.combat.attack.listener.other.prayer.regular.ranged.EagleEyeListener;
import net.arrav.world.entity.actor.combat.attack.listener.other.prayer.regular.ranged.HawkEyeListener;
import net.arrav.world.entity.actor.combat.attack.listener.other.prayer.regular.ranged.SharpListener;
import net.arrav.world.entity.actor.combat.attack.listener.other.prayer.regular.strength.BurstOfStrengthListener;
import net.arrav.world.entity.actor.combat.attack.listener.other.prayer.regular.strength.SuperhumanStrengthListener;
import net.arrav.world.entity.actor.combat.attack.listener.other.prayer.regular.strength.UltimateStrengthListener;
