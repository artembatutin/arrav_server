package net.arrav.content.skill.agility.impl.gnome;
...
import net.arrav.content.skill.agility.impl.gnome.impl.JumpOverBarrier;
import net.arrav.content.skill.agility.impl.gnome.impl.PoleSwing;
...
import net.arrav.content.skill.agility.obstacle.impl.Climbable;
