package net.arrav.content.skill.agility.impl.barb;
...
import net.arrav.content.skill.agility.impl.barb.impl.BalanceBeam;
import net.arrav.content.skill.agility.impl.barb.impl.SlideDownRoof;
