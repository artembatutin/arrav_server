package net.arrav.content.skill.agility;

import net.arrav.content.skill.agility.impl.barb.BarbarianOutpostAgility;
import net.arrav.content.skill.agility.impl.gnome.GnomeStrongholdAgility.GnomeAgilityData;
