...
import net.arrav.world.entity.item.container.ItemContainerAdapter;
import net.arrav.world.entity.item.container.ItemWeightListener;

import java.util.Optional;

import static net.arrav.world.entity.item.container.impl.EquipmentType.WEAPON;
