...
import net.arrav.world.entity.item.IndexedItem;
...
import static net.arrav.world.entity.item.container.ItemContainer.StackPolicy.ALWAYS;
import static net.arrav.world.entity.item.container.ItemContainer.StackPolicy.STANDARD;
