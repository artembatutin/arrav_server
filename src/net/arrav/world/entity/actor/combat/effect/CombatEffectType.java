...
import net.arrav.world.entity.actor.combat.effect.impl.CombatAntifireEffect;
import net.arrav.world.entity.actor.combat.effect.impl.CombatPoisonEffect;
import net.arrav.world.entity.actor.combat.effect.impl.CombatSkullEffect;
import net.arrav.world.entity.actor.combat.effect.impl.CombatTeleblockEffect;
import net.arrav.world.entity.actor.player.assets.AntifireDetails.AntifireType;
