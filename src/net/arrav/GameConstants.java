...
public final class GameConstants {
	 ...
	 * sequence.
	 */
	public static final int LOGIN_THRESHOLD = 30;
	 ...
	 */
	public static final Position STARTING_POSITION = new Position(3087, 3499);
	 ...
	 */
	public static final String[] BAD_STRINGS = {"fag", "f4g", "faggot", "nigger", "fuck", "bitch", "whore", "slut", "gay", "lesbian", "scape", ".net", ".org", "vagina", "dick", "cock", "penis", "hoe", "soulsplit", "ikov", "elkoy", "retard", "cunt"};
