...
import net.edge.cache.net.ondemand.OnDemandRequestDecoder;
import net.edge.cache.net.ondemand.OnDemandResponseEncoder;
import net.edge.cache.net.service.ServiceRequestDecoder;
import net.edge.cache.net.service.ServiceResponseEncoder;
